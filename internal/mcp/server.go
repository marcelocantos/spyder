...
func (h *Handler) toolHandlers() map[string]toolFunc {
	return map[string]toolFunc{
		...
		"app_sensor_override_enable": h.handleAppSensorOverrideEnable,
		"app_sensor_override_set":    h.handleAppSensorOverrideSet,
		"app_sensor_mute_enable":     h.handleAppSensorMuteEnable,
		"app_sensor_disable":         h.handleAppSensorDisable,
